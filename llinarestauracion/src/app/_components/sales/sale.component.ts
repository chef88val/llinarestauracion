...
import { Item, Family, Sale, Delivery } from 'src/app/_models';
...
//Facturas
export class SaleComponent implements OnInit, ownComponent {
  ...
  componentName = { singular: 'Facturas', plural: 'Factura' };

  elementActive: Sale = new Sale();
  constructor(
